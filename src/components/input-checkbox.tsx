...
//peer é o grupo, porem para componentes irmãos, e não hierárquicos 
const inputCheckboxVariants = cva(//appearance-none reseta as propriedades do checkbox
    `
    ...
    variants: {
        variant: {
            ...
            default: `
                ...
                group-hover:checked:border-green-dark group-hover:bg:border-green-dark
            `
        },
        size: {
